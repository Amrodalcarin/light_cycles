...
[RAINAction]
public class Move_left_away_green : RAINAction
{
    // Movement Speed
    ...
    {
        if (GameObject.Find("Player_orange").transform.position.x > GameObject.Find("Player_green").transform.position.x && ai.WorkingMemory.GetItem<string>("direccion") != "right")
        {
