...
[RAINAction]
public class Move_right_away : RAINAction
{
    // Movement Speed
    ...
    {
        if (GameObject.Find("Player_green").transform.position.x < GameObject.Find("Player_orange").transform.position.x && ai.WorkingMemory.GetItem<string>("direccion") != "left")
        {
